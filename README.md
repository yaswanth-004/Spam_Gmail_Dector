...
On the Scopes page, you can optionally add the specific Gmail API scopes your application needs.
...
Download the JSON file: A dialog box will appear with your Client ID and Client Secret.
